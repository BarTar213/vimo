...
export const mapMoviePreviewForOverviewFromBackend = (entity) => {
  entity.to = `/movie/${entity.id}`
  entity.release_date = dateMapping(entity.release_date)
  entity.poster_path = `${imageAddress.overviewPoster}${entity.poster_path}`
  return entity
}

export const mapMoviePreviewForTrendingFromBackend = (entity) => {
  entity.to = `/movie/${entity.id}`
  entity.release_date = dateMapping(entity.release_date)
  entity.poster_path = `${imageAddress.trendingPoster}${entity.poster_path}`
  return entity
}
...
export const mapPreviewListFromBackend = (input) => {
  input.map((entity) => {
    return mapMoviePreviewForOverviewFromBackend(entity)
  })
}

export const mapTrendingListFromBackend = (input) => {
  input.map((entity) => {
    return mapMoviePreviewForTrendingFromBackend(entity)
  })
}
